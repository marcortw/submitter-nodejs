...
acdp.consume({"url": "https://www.google.com/aaa"}, function(err,result){
    if (err){
        console.log("Demand invalid");
    } else {
        console.log(JSON.stringify(result));
    }
});
//acdp.consume({"url": "https://www.google.com:8080/aaa"});
//acdp.consume({"ip": "74.125.136.105", "tcp":80})
//acdp.consume([{"url": "http://www.google.com:80/aaa"},{"url": "https://www.google.com:443/aaa"}])
//acdp.consume({"app": "1234567890123"})
//acdp.consume([{"app": "1234567890123"},{"app": "42424242"}])
//acdp.consume([{"app": "1234567890123"},{"app": "42424242"}])
//acdp.consume({"url": "https://www.google.com:8080/443"})
...
//acdp.consume([{"ip": "74.125.136.0-74.125.136.255"},{"url": "https://www.google.com:443/aaa"}])
//
//
