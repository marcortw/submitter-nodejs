...
var L3ep = require('./model/NetworkEndpoint');
var L4ep = require('./model/TransportEndpoint');
...
module.exports = {
    ...
    objectsFromUrl: function (givenUrl, callback) {
        ...
        async.parallel([
            function (callback) {
                var l3obj = new L3ep();
                module.exports.validateIp(givenUrl, function (err, res) { // TODO: If an IP is supplied as a hostname, this miracoulously fails
                    if (err) {
